...
const IMGS_A = [
  'https://static.wixstatic.com/media/da1870_36f66643bd914f939ea4d9b01b2a52c2~mv2_d_5472_3648_s_4_2.jpg/v1/fill/w_816,h_459,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/IMG_1364_JPG.jpg',
  'https://static.wixstatic.com/media/da1870_1bc341fdeacc4a95911130397fa55959f000.jpg/v1/fill/w_818,h_459,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/da1870_1bc341fdeacc4a95911130397fa55959f000.jpg',
  ...
  'https://static.wixstatic.com/media/da1870_f6690e201ff84b28b55c202913efbc66f000.jpg/v1/fill/w_816,h_459,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/da1870_f6690e201ff84b28b55c202913efbc66f000.jpg',
];
...
function MarqueeRow({ images, reverse }) {
  ...
  return (
    <div className={`marquee-row ${reverse ? 'row2' : 'row1'}`}>
      {doubled.map((src, i) => (
        <img key={i} className="gallery-img" src={src} alt="Crystal Dental" loading="lazy" />
      ))}
    </div>
  );
}
  ...
  return (
    <section className="gallery-section">
      ...
      <div className="marquee-track">
        <MarqueeRow images={IMGS_A} reverse={false} />
        <MarqueeRow images={IMGS_B} reverse={true}  />
      </div>
    </section>
  );
}
