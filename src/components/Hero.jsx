...
export default function Hero() {
  ...
  return (
    <section className="hero" dir={isAr ? 'rtl' : 'ltr'} ref={sectionRef}>
      ...
      >
        ...
        <motion.h1
          className="hero-h1"
          variants={item}
          style={{ fontFamily: isAr ? "'Tajawal', sans-serif" : "'Cormorant Garamond', serif" }}
        >
          <BlurText
        ...
        <motion.div className="grad-line hero-divider" variants={item} />
        ...
        <motion.div className="hero-btns" variants={item}>
          <motion.a
            href="tel:+96522970112"
            className="btn btn-phone"
            whileHover={{ scale: 1.03, boxShadow: '0 8px 24px rgba(229,25,125,0.35)' }}
            whileTap={{ scale: 0.97 }}
          >
          ...
          <motion.a
            href="https://reach.link/crystaldental"
          ...
          <motion.a
            href="https://www.google.com/maps/search/Crystal+Dental+Center+Ahmed+Aljaber+Street+Sharq+Kuwait"
            target="_blank" rel="noopener"
            className="btn btn-maps"
            whileHover={{ scale: 1.03, borderColor: '#1976D2', color: '#1976D2' }}
            whileTap={{ scale: 0.97 }}
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
